...
from lab3.common.instructions import AluOp, DataWord, Instruction
...
# pylint: disable=too-few-public-methods
class ZeroReg(Component):
    def get_value(self) -> int:
        return 0


class Register(Component):
    def __init__(self, input_reg: Component):
...
class Mux(Component):
    def __init__(self, *input_regs: Component):
...
class InstructionMemory:
    def __init__(self, pc: Component, instructions: list[Instruction]):
        self.pc = pc
...
class IoInterface(Component):
    def __init__(self, input_reg: Component, char_stream: list[str]):
        self.input_reg = input_reg
...
class DataMemory(Component):
    def __init__(self, data_in: Component, address_in: Component, memory: list[DataWord]):
...
class ALU(Component):
    def __init__(self, left_operand: Component, right_operand: Component):
