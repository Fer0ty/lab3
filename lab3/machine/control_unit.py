...
from lab3.common.instructions import OpCode
from lab3.machine.datapath import DataPath
from lab3.machine.microcode import BranchingMicroCode, MicroCode
        ...
        if isinstance(microcode, MicroCode):
            ...
            if microcode.execute(self.datapath):
                if isinstance(microcode.branch_target, str):
                    raise ValueError("Microcode branch target not converted to int")
